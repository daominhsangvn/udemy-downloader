                ...
                if lecture_id:
                    ...
                    if asset.get("stream_urls") == None:
                        ...
                        if data and isinstance(data, list):
                            logger.info(">> DRM CONTENT:")
                            logger.info(">> Chapter: " + chapter_title)
                            logger.info(">> Lecture: " + lecture_title)
                            raise Exception("DRM Detected >> " + course_url + "/learn/lecture/" + str(lecture_id))
